...
// Replace vscode-a2ml, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= vscode-a2ml — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining vscode-a2ml for
