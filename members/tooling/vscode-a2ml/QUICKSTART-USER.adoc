...
// Replace vscode-a2ml, Vscode A2Ml — See README.adoc for details., just run, Vscode A2Ml started successfully. with actuals
= vscode-a2ml — Quick Start for Users
:toc:
:toclevels: 2

== What is vscode-a2ml?

Vscode A2Ml — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./vscode-a2ml-portable
----
...
[source]
----
Vscode A2Ml started successfully.
----
